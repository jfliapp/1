  ...
  <header class="header">
    <el-menu :default-active="activeIndex" class="el-menu-header" mode="horizontal" :ellipsis="false"
      ...
      <div class="header-right">
        <el-menu-item>
          <span class="mlr-20" @click="goOtherUrl('sign-in')">登录</span>
        </el-menu-item>
        <el-menu-item>
          <span class="mlr-20" @click="goOtherUrl('sign-up')">注册</span>
        </el-menu-item>
...
const menu = [
  ...
  },
  {
    ...
    prefixPath: 'news',
    arr: [
      { title: '公告', name: '2', prefixPath: 'news' },
      { title: '行業新聞', name: '4', prefixPath: 'news' }
    ]
  },
]
const langs = [
